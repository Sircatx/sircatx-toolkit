...
const EN: Translations = {
	...
	quickPagesHeading: "Favorite notes",
	quickPagesName: "Mobile function area",
	quickPagesDesc: "Add favorite notes to Obsidian's mobile function area. Open them by tapping the note name in the More menu at the top right of a note. These shortcuts are not shown on desktop.",
	quickPage: (number) => `Quick page ${number}`,
	chooseQuickPage: "Click to choose a note",
	addQuickPageDesc: "Add a favorite note to the mobile function area.",
...
const KO: Translations = {
	...
	myHomepage: "내 홈페이지",
	quickPagesHeading: "즐겨찾는 노트",
	quickPagesName: "모바일 기능 영역",
	quickPagesDesc: "즐겨찾는 노트를 Obsidian 모바일 기능 영역에 추가합니다. 노트 오른쪽 위의 더보기 메뉴에서 노트 이름을 눌러 빠르게 열 수 있으며 데스크톱에는 표시되지 않습니다.",
	quickPage: (number) => `빠른 페이지 ${number}`,
	chooseQuickPage: "클릭하여 노트 선택",
	addQuickPageDesc: "모바일 기능 영역에 즐겨찾는 노트를 추가합니다.",
...
const ZH_CN: Translations = {
	...
	myHomepage: "我的主页",
	quickPagesHeading: "常用笔记",
	quickPagesName: "手机端功能区",
	quickPagesDesc: "将常用笔记添加到 Obsidian 手机端功能区。添加后，可从笔记页面右上角的更多菜单中点击笔记名称快速打开；该功能不会在电脑端显示。",
	quickPage: (number) => `快捷页面 ${number}`,
	chooseQuickPage: "点击选择笔记",
	addQuickPageDesc: "将常用笔记添加到手机端功能区。",
	addQuickPage: "添加快捷页面",
